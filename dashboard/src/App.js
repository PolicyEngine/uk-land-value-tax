        ...
        <section id="methodology" className="dashboard-section methodology-section">
          <details className="methodology-note" open={false}>
            ...
            <div className="methodology-content">
              <p>Land values are estimated in two steps. First, household-level land holdings are imputed from the <a href="https://www.ons.gov.uk/peoplepopulationandcommunity/personalandhouseholdfinances/debt/methodologies/wealthandassetssurveyqmi" target="_blank" rel="noopener noreferrer">Wealth and Assets Survey</a> using quantile random forest models trained on the <a href="https://github.com/PolicyEngine/policyengine-uk-data" target="_blank" rel="noopener noreferrer">Enhanced FRS</a> 2023-24 microdata. Second, each household's land value is computed by multiplying its property wealth and corporate wealth by national intensity ratios derived from the <a href="https://www.ons.gov.uk/economy/nationalaccounts/uksectoraccounts/bulletins/nationalbalancesheet/2025" target="_blank" rel="noopener noreferrer">ONS</a> National Balance Sheet, then adding any directly held land. These ratios are uniform across regions, so regional variation in land values reflects differences in property and corporate wealth rather than local land prices.</p>
